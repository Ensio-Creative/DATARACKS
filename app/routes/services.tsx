    ...
    return (
        <>
            ...
            <section className='max-w-7xl mx-auto px-4 my-20'>
                {allServices.map((single, index) => <div
                    id={stringToSlug(single.title)} key={index + single.title}
                    className="grid md:grid-cols-3 md:gap-20 gap-4 border-b last:border-b-0 border-[#CFCFCF] py-10 pt-32">
                    <div>
